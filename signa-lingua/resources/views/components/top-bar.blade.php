<div class="flex items-center justify-between mb-[40px]">
    <button type="button" class="w-[45px] h-[45px] border rounded-xl flex items-center justify-center bg-[#EBF6F4]">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.75 6.75H20.25M3.75 12H20.25M3.75 17.25H20.25" stroke="#004066" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>     
    </button>
    <p class="font-bold text-[#004066]">HOME</p>
    <button type="button" class="w-[45px] h-[45px] border rounded-xl flex items-center justify-center bg-[#EBF6F4]">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
